...
namespace KinectV2Viewer
{
    public class YoloWrapper_custom: IDisposable
    {
        ...
        public IEnumerable<YoloItem_custom> Detect(string filepath)
        {
        ...
        public IEnumerable<YoloItem_custom> Detect(byte[] imageData)
        {
        ...
        /// <returns></returns>
        /// <exception cref="NotImplementedException">Thrown when the yolo_cpp dll is wrong compiled</exception>
        public IEnumerable<YoloItem_custom> Detect(IntPtr imagePtr, int size)
        {
            var container = new BboxContainer_custom();
        ...
        private IEnumerable<YoloItem_custom> Convert(BboxContainer_custom container)
        {
            return container.candidates.Where(o => o.h > 0 || o.w > 0).Select
            (o =>
